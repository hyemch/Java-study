...
select '2024-11-18', cast('2024-04-25' as date), convert('2024-11-18' , datetime);
select str_to_date('2014-11-12', '%Y-%d-%m');
...
select dept, group_concat(ename) from Emp group by dept;

select concat ('abc', ':', "efg", ":", null, ":", "hij"), concat_ws(':', "abc", "efg", null, "hij");
